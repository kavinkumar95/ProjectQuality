...
docker exec -it "dataquality" /bin/bash -c "curl -X POST -H 'Content-Type: application/json' -d '$json_data' http://localhost:8084/api/quality/generateConfigYaml/DEF -o config.zip"
